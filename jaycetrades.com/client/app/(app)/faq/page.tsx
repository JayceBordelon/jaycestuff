...
const faqs = [
	{
		...
		answer: `Every market day at 9:25 AM ET, our system scrapes trending tickers
	...
	},
	{
		...
		answer: `Each morning, the AI ranks all 10 picks from 1 (highest conviction)
		to 10 (lowest conviction). Rank 1 is the single best trade idea of the day.
		The Top N filter lets you narrow the dashboard and historical analytics to
		only the highest-ranked picks. If you have limited capital or prefer fewer,
		higher-quality positions, filter to Top 1 or Top 3. If you want broader
		exposure, view all 10. The historical performance page recalculates all
		metrics (win rate, P&L, Sharpe ratio, etc.) based on your selected filter,
		so you can compare how different tiers have performed over time.`,
	},
	{
		question: "Is the P&L shown based on real trades?",
		answer: `No. JayceTrades does not execute any trades. All P&L figures are
		hypothetical. They assume you bought one contract of each suggested trade at
		the estimated market open price (the option's mark price from Schwab at
		9:25 AM) and sold at the closing mark price (captured at 4:05 PM). The
		calculation is (closing premium − entry premium) × 100 per contract.
		Real-world results would differ due to bid-ask spreads, slippage,
		commissions, liquidity, and execution timing. These numbers are meant to
		track the quality of the AI's picks over time, not to represent actual
		portfolio returns.`,
	},
	{
	...
	},
	{
		...
		answer: `Subscribers receive up to three emails per week-day. The morning
		email (before 9:30 AM ET) contains all 10 ranked picks with contract
		details, thesis, sentiment, catalyst, and risk level. The end-of-day email
		(after 4:05 PM ET) shows how each pick performed — entry vs. closing price,
		stock movement, and per-trade P&L. On Fridays, a weekly summary email
		aggregates the full week's performance with win rate, total P&L, best/worst
		trades, and a hypothetical buy-at-open/sell-at-close analysis. All emails
